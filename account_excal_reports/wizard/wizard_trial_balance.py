...
class account_balance_report(osv.osv_memory):
    ...
    def check_report_excel(self, cr, uid, ids, context=None):
        ...
        data['form'] = self.read(cr, uid, ids, ['currency_id_second','currency_id','amount_currency','date_from',  'date_to',  'fiscalyear_id', 'journal_ids', 'period_from', 'period_to',  'filter',  'chart_account_id', 'target_move'], context=context)[0]
