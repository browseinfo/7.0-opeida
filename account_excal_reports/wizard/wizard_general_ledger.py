...
class account_report_general_ledger(osv.osv_memory):
    ...
    def print_report_excel(self, cr, uid, ids, data, context=None):
        ...
        if data['form'].get('currency_id_second',False):
            data['form']['currency_id_second'] =  data['form']['currency_id_second'][0]
    ...
    def check_report_excel(self, cr, uid, ids, context=None):
        ...
        data['form'] = self.read(cr, uid, ids, ['currency_id_second','currency_id','date_from',  'date_to',  'fiscalyear_id', 'journal_ids', 'period_from', 'period_to',  'filter',  'chart_account_id', 'target_move'])[0]
